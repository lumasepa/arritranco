...
from views import hosts, hosts_ext_info, backup_checks, get_checks, refresh_nagios_status, json_migration
...
#    url(r'^load_checks.cfg$', generic_checks, {'template':'nagios/load_checks.cfg'}, name='load_checks'),
    ...
    url(r'^json_migration$', json_migration, name='json_migration'),
)
